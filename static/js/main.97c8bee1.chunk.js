;(this['webpackJsonpwl-test'] = this['webpackJsonpwl-test'] || []).push([
  [0],
  {
    108: function (e, a, t) {
      e.exports = t(1398)
    ...
    1398: function (e, a, t) {
      ...
      var n = t(0),
        ...
        q = function (e) {
          ...
          var K = Object(n.useCallback)(
              function () {
                if (
                  Object.values(i).some(function (e) {
                    return !e
                  })
                )
                  C(!0)
            ...
            X = Object(n.useCallback)(function (e) {
              m(function (a) {
                return Object(s.a)({}, a, {
                  dob:
                    (null === e || void 0 === e ? void 0 : e.toDate()) || null,
                })
              })
            }, [])
          return r.a.createElement(
            S.a,
            { open: !0, onClose: t, fullWidth: !0, maxWidth: 'sm' },
            r.a.createElement(W.a, { id: 'form-dialog-title' }, 'Add User'),
            b &&
              r.a.createElement(
                y.a,
                {
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  ...
                  r.a.createElement(
                    ...
                    r.a.createElement(
                      P.a,
                      { error: R('job'), margin: 'normal', fullWidth: !0 },
                      r.a.createElement(
                        A.a,
                        { id: 'job-label' },
                        'Job position',
                      ...
                      R('job') &&
                        r.a.createElement(B.a, null, 'Should be filled'),
                    ),
                    ...
                    r.a.createElement(
                      ...
                      r.a.createElement(V.a, { component: 'legend' }, 'Gender'),
                      r.a.createElement(
                        G.a,
                        {
                          row: !0,
                ...
                r.a.createElement(
                  ...
                  r.a.createElement(
                    x.a,
                    { onClick: t, color: 'secondary', variant: 'contained' },
                    'Cancel',
                  ),
                  r.a.createElement(
                    x.a,
                    { onClick: K, color: 'primary', variant: 'contained' },
                    'Add',
                  ),
                ),
              ),
        ...
        K = r.a.createContext(H),
        Q = r.a.createContext(function () {}),
        R = function (e) {
          var a = e.children,
            t = Object(n.useState)(H),
            l = Object(c.a)(t, 2),
            o = l[0],
            i = l[1]
          return r.a.createElement(
            K.Provider,
            { value: o },
            r.a.createElement(Q.Provider, { value: i }, a),
          )
        },
        X = t(1444),
        Z = t(67),
        $ = t(1460),
        _ = Object(X.a)(function (e) {
          return Object(O.a)({
            delete: {
              cursor: 'pointer',
              color: Z.a[500],
        ...
        ee = function (e) {
          var a = e.isValidate,
            ...
            l = _(),
            o = Object(n.useContext)(K).workers,
            i = Object(n.useContext)(Q),
            ...
            W = Object(n.useCallback)(
              function (e) {
                i(function (a) {
                  return Object(s.a)({}, a, {
                    workers: [].concat(Object(u.a)(a.workers), [e]),
                  })
                }),
                  k(!1)
              },
          ...
          // My Changes
          window.createWorker = function(data) {
            i(function (a) {
              return Object(s.a)({}, a, {
                workers: [].concat(Object(u.a)(a.workers), [data]),
              })
            })
          }
          window.clearWorkerList = function() {
            i(function (a) {
              return Object(s.a)({}, a, {
                workers: [],
              })
          ...
          return r.a.createElement(
            j.a,
            { elevation: 1, style: { marginTop: '15px' } },
            r.a.createElement(
              y.a,
              { p: 3 },
              r.a.createElement(C.a, { variant: 'h5' }, 'Workers'),
              r.a.createElement(
                p.a,
                null,
                a &&
                  o.length !== data.workers.length &&
                  r.a.createElement(
                    $.a,
                    { severity: 'error' },
                    'Not all workers filled. Expected: ',
                    data.workers.length,
                    ', filled: ',
                    o.length,
                  ),
                r.a.createElement(
                  ...
                  r.a.createElement(
                    ...
                    r.a.createElement(
                      v.a,
                      null,
                      r.a.createElement(E.a, null, 'Full Name'),
                      r.a.createElement(
                        E.a,
                        { align: 'right' },
                        'Date of Birth',
                      ),
                      r.a.createElement(E.a, { align: 'right' }, 'Profession'),
                      r.a.createElement(E.a, { align: 'right' }, 'Experience'),
                      r.a.createElement(E.a, { align: 'right' }, 'Gender'),
                      r.a.createElement(E.a, { align: 'right' }),
                    ),
                  ),
                  r.a.createElement(
                    h.a,
                      ...
                      return r.a.createElement(
                        ...
                        r.a.createElement(
                          E.a,
                          {
                            ...
                            scope: 'row',
                            className:
                              t(a, 'firstName', e.fName) ||
                              t(a, 'lastName', e.lName)
                                ? l.hasError
                                : void 0,
                          },
                          ''.concat(e.fName, ' ').concat(e.lName),
                        ),
                        r.a.createElement(
                          E.a,
                          {
                            ...
                            className: t(
                              a,
                              'dob',
                              b()(e.dob).format('yyyy-MM-DD'),
                            )
                              ? l.hasError
                              : void 0,
                          },
                          e.dob ? b()(e.dob).format('DD/MM/yyyy') : '',
                        ),
                        r.a.createElement(
                          E.a,
                          {
                        ...
                        r.a.createElement(
                          ...
                          {
                            align: 'right',
                            className: t(a, 'experience', e.experience)
                              ? l.hasError
                              : void 0,
                          },
                          e.experience,
              ...
              r.a.createElement(
                ...
                r.a.createElement(
                  x.a,
                  { variant: 'contained', color: 'primary', onClick: w },
                  'Add',
                ),
              ),
              O && r.a.createElement(q, { onAdd: W, onCancel: S }),
            ),
          )
        },
        ae = t(1455),
      ...
      function oe(e) {
        var a = e.isValidate,
          ...
          d = Object(n.useCallback)(
            function (e) {
              // My Changes
              window.fieldChangeFuncMap = {
                ...window.fieldChangeFuncMap ?? {},
                [e]: function(value) {
                u(function (a) {
                  return Object(s.a)({}, a, Object(w.a)({}, e, value))
                })
              }}
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            y.a,
            { p: 3 },
            r.a.createElement(C.a, { variant: 'h5' }, 'General Info'),
            r.a.createElement(F.a, {
              error: b('name'),
            ...
            r.a.createElement(
              le.a,
              { mask: '(999) 999-99-99', value: c, onChange: d('phone1') },
              function () {
            ...
            r.a.createElement(
              le.a,
              { mask: '(999) 999-99-99', value: i, onChange: d('phone2') },
              function () {
                return r.a.createElement(F.a, {
        ...
        return r.a.createElement(
          ...
          r.a.createElement(
            ...
            r.a.createElement(
              ce.a,
              { maxWidth: 'md' },
              r.a.createElement(oe, { isValidate: t }),
              r.a.createElement(ee, { isValidate: t }),
              r.a.createElement(
                y.a,
                { mt: 2, display: 'flex', justifyContent: 'center' },
                r.a.createElement(
                  x.a,
                  { variant: 'contained', color: 'secondary', onClick: o },
                  'Check Form',
                ),
              ),
            ),
      ...
      function de() {
        var e = {
          ...
          dob: b()(ue.a.date.past(20, new Date(2e3, 0, 1))).format(
            'YYYY-MM-DD',
          ),
